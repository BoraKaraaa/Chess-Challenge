...
namespace ChessChallenge.Example
{
    ...
    private const int ABSOLUTE_WIN = 50;
    ...
    private void GenerateChildrenMoveNodes(MoveNode parentMoveNode, out int legalMoveCount)
    {
    ...
    private MoveNode MiniMax(MoveNode moveNode, int depth, int alpha, int beta, bool maximizingPlayer)
    {
        ...
        GenerateChildrenMoveNodes(moveNode, out int legalMoveCount);

        // take total legal move count and determine depth dynamically
